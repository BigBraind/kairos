defmodule LifecycleWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :lifecycle
  ...
  socket "/socket", LifecycleWeb.UserSocket,
      websocket: true,
      longpoll: false
  ...
  if code_reloading? do
    ...
    plug Phoenix.Ecto.CheckRepoStatus, otp_app: :lifecycle
  end
