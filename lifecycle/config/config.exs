...
config :lifecycle, LifecycleWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: LifecycleWeb.ErrorView, accepts: ~w(html json), layout: false],
  pubsub_server: Lifecycle.PubSub,
  live_view: [signing_salt: "ZIhMR9Ws"]
...
config :lifecycle, Lifecycle.Mailer, adapter: Swoosh.Adapters.Local
